...
Enterprisecoding Network Namespace detaylı kullanım senaryosuna hoş geldiniz.

## Senaryo

Bu senaryoda, container teknolojisinin olmazsa olmazı namespace'lerden birisi olan Network namespace'i ve detaylı kullanımı deneyimleyebilirsiniz.
