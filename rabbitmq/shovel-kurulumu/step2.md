...
Açılan bölümde **Name** alanına `lab.shovel.queue.kaynak`{{copy}} değerini yazın ve **Add queue** butonuna basın.
...
Açılan bölümde **Name** alanına `lab.shovel.queue.hedef`{{copy}} değerini yazın ve **Add queue** butonuna basın.
