...
Açılan bölümde **Name** alanına **lab.queue.events.queue.created** değerini yazın ve **Add queue** butonuna basın.
...
Yeniden aynı ekranda **Name** alanına **lab.queue.events.exchange.created** değerini yazın ve **Add queue** butonuna basın.
