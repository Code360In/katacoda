...
Açılan bölümde **Name** alanına **queue.lab.is-emirleri.personel** değerini yazın ve **Add queue** butonuna basın.
...
Yeniden aynı ekranda **Name** alanına **queue.lab.is-emirleri.personel.ayrilma** değerini yazın ve **Add queue** butonuna basın.
