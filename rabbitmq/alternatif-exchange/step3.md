...
Açılan bölümde **Add binding from this exchange** alanına **To queue** değerine **queue.lab.is-emirleri.personel.ayrilma** yazın. **Routing key** alanına **personel.is-emri.ayrilma** değerini yazın ve **Bind** butonuna basın.
