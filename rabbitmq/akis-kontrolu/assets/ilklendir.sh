...
/opt/rabbitmq-perf-test-2.14.0/bin/runjava com.rabbitmq.perf.PerfTest -h amqp://enterprisecoding:enterprisecoding@localhost/default  -x 3 -y 2 -exchange=flowControlExchange -f persistent -u lab.queue.is-emirleri.personel.ayrilma -p  -z 60
EOF
