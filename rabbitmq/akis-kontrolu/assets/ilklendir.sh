...
rabbitmqadmin -u enterprisecoding -p enterprisecoding declare exchange --vhost=default name=flowControlExchange type=direct

echo "Queue oluşturuluyor..."
rabbitmqadmin -u enterprisecoding -p enterprisecoding declare queue --vhost=default name=ayrilma-is-emirleri durable=true

echo "Binding oluşturuluyor..."
rabbitmqadmin -u enterprisecoding -p enterprisecoding declare binding --vhost=default source=flowControlExchange destination=ayrilma-is-emirleri routing_key="personel.is-emri.ayrilma
